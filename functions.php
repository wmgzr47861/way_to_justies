...
{
    $average = 0;
    $avgQuery = "SELECT rating FROM tbl_ratin WHERE user_id = '" . $userId . "' and restaurant_id = '" . $restaurantId . "'";
    $total_row = 0;
...
{
    $totalVotesQuery = "SELECT * FROM tbl_ratin WHERE restaurant_id = '" . $restaurantId . "'";
